...
\cventry{\dates[September.2026-.present]}
{EDIC PhD Fellow}
{\newline École Polytechnique Fédérale de Lausanne (\textbf{EPFL})}{
	Lausanne, Switzerland
}{}{}

\cventry{\dates[April.2023-March.2026]}
...
\cvitem{\date[.2026]}{
	\textbf{Real-time Rendering with a Neural Irradiance Volume}
	\newline
	Arno Coomans,
	Giacomo Nazzaro,
	Edoardo A. Dominici,
	...
	Markus Steinberger
	\newline
	\href{https://arxiv.org/abs/2602.12949}{\faFilePdf \hspace{1pt} arXiv}
}
...
\cvitem{\dates[June.2026-Aug.2026]} {
	\textbf{Research Intern},
	\textit{Disney Research} Zurich,
	\begin{itemize}
		\item Post render edits
	\end{itemize}
}
\cvitem{\dates[May.2026-May.2026]} {
	\textbf{Research Intern},
	\textit{Realistic Graphics Laboratory},
	\textit{EPFL}
	\begin{itemize}
		\item Neural Materials
	\end{itemize}
}
\cvitem{\dates[September.2025-March.2026]} {
	\textbf{Masters Thesis},
	\textit{Realistic Graphics Laboratory},
	\textit{EPFL}
	\begin{itemize}
		\item Representing Mesoscale Detail in Neural Materials
	\end{itemize}
}
\cvitem{\dates[April.2025-August.2025]} {
	\textbf{Research Intern},
	\textit{NVIDIA} Zurich
	\begin{itemize}
		\item Function Level Caching for Dr.Jit and Mitsuba~3
		\item Hash Grid for Dr.Jit
		\item Differentiable Radio Frequency Modeling with Sionna RT
	\end{itemize}
}
\cvitem{\dates[April.2024-April.2025]} {
	\textbf{Research Working Student},
	\textit{Huawei Technologies} Munich
	\begin{itemize}
		\item Development on Dr.Jit/Mitsuba~3
...
\cvitem{\dates[July.2021-August.2021]} {
	\textbf{Embeded Systems Intern},
	\textit{Aurum GmbH} Munich
	\begin{itemize}
...
\cvitem{\date[July.2017]} {
	\textbf{Intern},
	\textit{Lauterbach GmbH}
}
\cvitem{\date[July.2017]} {
	\textbf{Intern},
	\textit{Electronic Theater Controls (ETC)} Holzkirchen
}
